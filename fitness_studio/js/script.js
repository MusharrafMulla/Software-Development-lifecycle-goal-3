...
function toggleContent(currentVisibleId, nextVisibleId) {
  var currentVisible = document.getElementById(currentVisibleId);
  var nextVisible = document.getElementById(nextVisibleId);
